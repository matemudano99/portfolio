...
export const projects: Project[] = [
  {
    ...
    stack: ['Spring Boot', 'Next.js', 'PostgreSQL', 'Kotlin', 'JWT', 'JUnit', 'Mockito', 'Docker'],
    summary: {
    ...
    bullets: {
      en: [
        ...
        'Unit tests on the service layer with JUnit and Mockito',
      ],
      es: [
        ...
        'Tests unitarios de la capa de servicios con JUnit y Mockito',
      ],
    },
    shots: [
      {
...
export const skillGroups: SkillGroup[] = [
  { label: { en: 'languages', es: 'lenguajes' }, items: ['Java', 'Python', 'SQL', 'JavaScript', 'Kotlin (basics)'] },
  {
    ...
    items: ['Spring Boot', 'Hibernate', 'REST APIs', 'JDBC', 'JUnit · Mockito', 'MVC · OOP'],
  },
  {
